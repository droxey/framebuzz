...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.add_to_carousel'
        db.add_column(u'api_video', 'add_to_carousel',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.add_to_carousel'
        db.delete_column(u'api_video', 'add_to_carousel')
