...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserWebsite.added_on'
        db.add_column(u'api_userwebsite', 'added_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 8, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserWebsite.added_on'
        db.delete_column(u'api_userwebsite', 'added_on')
