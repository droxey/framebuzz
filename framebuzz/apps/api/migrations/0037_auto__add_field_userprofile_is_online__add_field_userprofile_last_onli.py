...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_online'
        db.add_column(u'api_userprofile', 'is_online',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.last_online_on'
        db.add_column(u'api_userprofile', 'last_online_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.channel'
        db.add_column(u'api_userprofile', 'channel',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_online'
        db.delete_column(u'api_userprofile', 'is_online')

        # Deleting field 'UserProfile.last_online_on'
        db.delete_column(u'api_userprofile', 'last_online_on')

        # Deleting field 'UserProfile.channel'
        db.delete_column(u'api_userprofile', 'channel')
    ...
    models = {
        ...
        u'api.userprofile': {
            ...
            'channel': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'last_online_on': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
