...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MPTTComment.has_hidden_siblings'
        db.add_column(u'api_mpttcomment', 'has_hidden_siblings',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MPTTComment.has_hidden_siblings'
        db.delete_column(u'api_mpttcomment', 'has_hidden_siblings')
