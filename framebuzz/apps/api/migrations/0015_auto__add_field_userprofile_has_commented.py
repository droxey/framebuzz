...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.has_commented'
        db.add_column(u'api_userprofile', 'has_commented',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.has_commented'
        db.delete_column(u'api_userprofile', 'has_commented')
