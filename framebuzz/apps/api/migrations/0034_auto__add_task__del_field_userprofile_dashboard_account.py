...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_task', (
            ...
            ('slug', self.gf('randomslugfield.fields.RandomSlugField')(exclude_lower=False, null=True, exclude_digits=False, exclude_upper=False, length=16, max_length=16, blank=True, unique=True)),
            ...
            ('assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='task_assigned_to', null=True, to=orm['auth.User'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Video'], null=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['Task'])

        # Deleting field 'UserProfile.dashboard_account'
        db.delete_column(u'api_userprofile', 'dashboard_account')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.dashboard_account'
        db.add_column(u'api_userprofile', 'dashboard_account',
    ...
    models = {
        ...
        u'api.task': {
            'Meta': {'ordering': "['-created_on', 'title']", 'object_name': 'Task'},
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'task_assigned_to'", 'null': 'True', 'to': u"orm['auth.User']"}),
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Video']", 'null': 'True', 'blank': 'True'})
        },
        u'api.thumbnail': {
        ...
        u'api.userprofile': {
            ...
            'dashboard_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'api.video': {
            ...
            'fp_url': ('django.db.models.fields.URLField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'notify_emails': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
