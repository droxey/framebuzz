...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.logo'
        db.add_column(u'api_userprofile', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.logo'
        db.delete_column(u'api_userprofile', 'logo')
