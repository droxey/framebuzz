...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MPTTComment.hidden_by_id'
        db.add_column(u'api_mpttcomment', 'hidden_by_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MPTTComment.hidden_by_id'
        db.delete_column(u'api_mpttcomment', 'hidden_by_id')
