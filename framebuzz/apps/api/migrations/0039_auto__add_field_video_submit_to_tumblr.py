...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.submit_to_tumblr'
        db.add_column(u'api_video', 'submit_to_tumblr',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.submit_to_tumblr'
        db.delete_column(u'api_video', 'submit_to_tumblr')
    ...
    models = {
        ...
        u'api.uservideo': {
            ...
            'tumblr_link': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'api.video': {
            ...
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('randomslugfield.fields.RandomSlugField', [], {'exclude_lower': 'False', 'null': 'True', 'exclude_digits': 'False', 'exclude_upper': 'False', 'length': '16', 'max_length': '16', 'blank': 'True', 'unique': 'True'}),
            'submit_to_tumblr': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
