...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_video', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'UserProfile.dashboard_enabled'
        db.add_column(u'api_userprofile', 'dashboard_enabled',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'api_video', 'public')

        # Deleting field 'UserProfile.dashboard_enabled'
        db.delete_column(u'api_userprofile', 'dashboard_enabled')
