...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrivateSession.is_synchronized'
        db.add_column(u'api_privatesession', 'is_synchronized',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PrivateSession.is_synchronized'
        db.delete_column(u'api_privatesession', 'is_synchronized')
