...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserVideo.tumblr_link'
        db.add_column(u'api_uservideo', 'tumblr_link',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserVideo.tumblr_link'
        db.delete_column(u'api_uservideo', 'tumblr_link')
