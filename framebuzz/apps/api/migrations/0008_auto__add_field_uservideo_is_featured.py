...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserVideo.is_featured'
        db.add_column(u'api_uservideo', 'is_featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserVideo.is_featured'
        db.delete_column(u'api_uservideo', 'is_featured')
