...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrivateSession'
        db.create_table(u'api_privatesession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('randomslugfield.fields.RandomSlugField')(exclude_lower=False, length=16, max_length=16, exclude_digits=False, blank=True, unique=True, exclude_upper=False)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.Video'])),
        ))
        db.send_create_signal(u'api', ['PrivateSession'])

        # Adding model 'SessionInvitation'
        db.create_table(u'api_sessioninvitation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.PrivateSession'])),
            ('invitee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('invited_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('accepted_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'api', ['SessionInvitation'])

        # Adding field 'MPTTComment.session'
        db.add_column(u'api_mpttcomment', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['api.PrivateSession'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PrivateSession'
        db.delete_table(u'api_privatesession')

        # Deleting model 'SessionInvitation'
        db.delete_table(u'api_sessioninvitation')

        # Deleting field 'MPTTComment.session'
        db.delete_column(u'api_mpttcomment', 'session_id')
