...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.premium'
        db.delete_column(u'api_userprofile', 'premium')

        # Deleting field 'UserProfile.profession'
        db.delete_column(u'api_userprofile', 'profession')

        # Deleting field 'UserProfile.youtube_username'
        db.delete_column(u'api_userprofile', 'youtube_username')

        # Adding field 'UserProfile.tagline'
        db.add_column(u'api_userprofile', 'tagline',
        ...
        db.alter_column(u'api_userprofile', 'bio', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):
        # Adding field 'UserProfile.premium'
        db.add_column(u'api_userprofile', 'premium',
        ...
        # Adding field 'UserProfile.youtube_username'
        db.add_column(u'api_userprofile', 'youtube_username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.tagline'
        db.delete_column(u'api_userprofile', 'tagline')
        ...
        # Changing field 'UserProfile.bio'
        db.alter_column(u'api_userprofile', 'bio', self.gf('django.db.models.fields.CharField')(max_length=180, null=True))
    ...
    models = {
        ...
        u'api.userwebsite': {
            'Meta': {'ordering': "['-added_on']", 'object_name': 'UserWebsite'},
            'added_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
