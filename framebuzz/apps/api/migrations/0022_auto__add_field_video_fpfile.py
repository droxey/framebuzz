...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Video.fpfile'
        db.add_column(u'api_video', 'fpfile',
                      self.gf('django_filepicker.models.FPFileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Video.fpfile'
        db.delete_column(u'api_video', 'fpfile')
    ...
    models = {
        ...
        u'api.video': {
            ...
            'fpfile': ('django_filepicker.models.FPFileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
