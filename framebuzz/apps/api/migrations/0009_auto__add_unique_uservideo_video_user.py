...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UserVideo', fields ['video', 'user']
        db.create_unique(u'api_uservideo', ['video_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserVideo', fields ['video', 'user']
        db.delete_unique(u'api_uservideo', ['video_id', 'user_id'])
