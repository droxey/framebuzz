...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[\w.@+-]+)/library/toggle/(?P<video_id>[\w.@+-]+)/$', 'framebuzz.apps.profiles.views.toggle_video_library', name='profiles-toggle-library'),
    url(r'^(?P<username>[\w.@+-]+)/library/featured/(?P<video_id>[\w.@+-]+)/$', 'framebuzz.apps.profiles.views.toggle_video_featured', name='profiles-toggle-featured'),
)