		...
		buildoverlays: function(player, controls, layers, media) {
			...
			bigPlay =
				$('<div class="mejs-overlay mejs-layer mejs-overlay-play">'+
					'<div class="mejs-overlay-button" role="button" aria-label="' + mejs.i18n.t('Play') + '" aria-pressed="false"><i class="fa fa-fw fa-4x fa-play" aria-label="Play"></i></div>'+
				'</div>')
				.appendTo(layers)
		...
		buildplaypause: function(player, controls, layers, media) {
			...
			function togglePlayPause(which) {
				if ('play' === which) {
					...
					play.find('i.fa').removeClass('fa-play').addClass('fa-pause');
					play_btn.attr({
						'title': op.pauseText,
					...
					play.find('i.fa').removeClass('fa-pause').addClass('fa-play');
					play_btn.attr({
						'title': op.playText,
			...
			var t = this,
				...
				$('<div class="mejs-button mejs-volume-button mejs-mute">'+
					'<button type="button" aria-controls="' + t.id +
						'" title="' + t.options.muteText +
						'" aria-label="' + t.options.muteText +
					'"><i class="fa fa-fw fa-volume-down"></i></button>'+
	...
	$.extend(MediaElementPlayer.prototype, {
		...
		buildfullscreen: function(player, controls, layers, media) {
			...
			var t = this,
				...
				fullscreenBtn =
					$('<div class="mejs-button mejs-fullscreen-button mejs-fbz-fullscreen">' +
						'<button class="mejs-fbz-fullscreen" type="button" aria-controls="' + t.id + '" title="' + t.options.fullscreenText + '" aria-label="' + t.options.fullscreenText + '"><i class="material-icons">fullscreen</i></button>' +
					'</div>')
					.appendTo(shareDiv)
					.on('click', function() {
