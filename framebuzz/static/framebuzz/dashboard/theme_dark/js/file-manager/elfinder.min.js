...
$.fn.elfinderbutton = function(cmd) {
	return this.each(function() {
		...
		var c        = 'class',
			...
			menu,
			button   = $(this).addClass('ui-state-default elfinder-button ttips')
...
$.fn.elfindersearchbutton = function(cmd) {
	return this.each(function() {
		var result = false,
			...
			input  = $('<input type="text" size="42" class="form-control" />')
				.appendTo(button)
		...
		$('<span class="ui-icon ui-icon-search ttips" title="'+cmd.title+'"><i class="icon-search"></i></span>')
			.appendTo(button)
			.click(search);
		
		$('<span class="ui-icon ui-icon-close icon-close"/>')
			.appendTo(button)
			.click(abort)
...
$.fn.elfindersortbutton = function(cmd) {
	...
	return this.each(function() {
		var fm       = cmd.fm,
			...
			asc      = selected+'-asc',
			desc     = selected+'-desc',
			button   = $(this).addClass('ui-state-default elfinder-button ttips elfinder-menubutton elfiner-button-'+name)
				.attr('title', cmd.title)
