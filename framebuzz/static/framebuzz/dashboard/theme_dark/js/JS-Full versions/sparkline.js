...
, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x, T, N, C, k, L, A, O, M, _, D, P, H, B, j=0;
    ...
    return {
    common:  {
    type: "line", lineColor:"#00f", fillColor:"#cdf", defaultPixelsPerValue:3, width:"auto", height:"auto", composite:false, tagValuesAttribute:"values", tagOptionsPrefix:"spark", enableTagOptions:false, enableHighlight:true, highlightLighten:1.4, tooltipSkipNull:true, tooltipPrefix:"", tooltipSuffix:"", disableHiddenCheck:false, numberFormatter:false, numberDigitGroupCount:3, numberDigitGroupSep:", ", numberDecimalMark:".", disableTooltips:false, disableInteraction:false;
}
, line: {
    spotColor: "#f80", highlightSpotColor:"#5f5", highlightLineColor:"#f22", spotRadius:1.5, minSpotColor:"#f80", maxSpotColor:"#f80", lineWidth:1, normalRangeMin:n, normalRangeMax:n, normalRangeColor:"#ccc", drawNormalOnTop:false, chartRangeMin:n, chartRangeMax:n, chartRangeMinX:n, chartRangeMaxX:n, tooltipFormat:new u('<span style="color:  {
     {
    color;
}
}">&#9679;
    ...
    barColor: "#3366cc", negBarColor:"#f44", stackedBarColor:["#3366cc", "#dc3912", "#ff9900", "#109618", "#66aa00", "#dd4477", "#0099c6", "#990099"], zeroColor:n, nullColor:n, zeroAxis:true, barWidth:4, barSpacing:1, chartRangeMax:n, chartRangeMin:n, chartRangeClip:false, colorMap:n, tooltipFormat:new u('<span style="color:  {
     {
    color;
}
}">&#9679;
...
, tooltipFormat:new u('<span style="color:  {
     {
    color;
}
}">&#9679;
    ...
    lineHeight: "auto", thresholdColor:n, thresholdValue:0, chartRangeMax:n, chartRangeMin:n, chartRangeClip:false, tooltipFormat:new u(" {
     {
    prefix;
}
} {
    ...
    targetColor: "#f33", targetWidth:3, performanceColor:"#33f", rangeColors:["#d3dafe", "#a8b6ff", "#7f94ff"], base:n, tooltipFormat:new u(" {
     {
    fieldkey: fields;
}
} -  {
    ...
    offset: 0, sliceColors:["#3366cc", "#dc3912", "#ff9900", "#109618", "#66aa00", "#dd4477", "#0099c6", "#990099"], borderWidth:0, borderColor:"#000", tooltipFormat:new u('<span style="color:  {
     {
    color;
}
}">&#9679;
    ...
    raw: false, boxLineColor:"#000", boxFillColor:"#cdf", whiskerColor:"#000", outlierLineColor:"#333", outlierFillColor:"#fff", medianColor:"#f00", showOutliers:true, outlierIQR:1.5, spotRadius:1.5, target:n, targetColor:"#4a2", chartRangeMax:n, chartRangeMin:n, tooltipFormat:new u(" {
     {
    field: fields;
}
}:  {
...
}"), tooltipFormatFieldlistKey: "field", tooltipValueLookups: {
    fields:  {
...
\;
}/g, precre:/(\w+)\.(\d+)/, init:function(e, t) {
    this.format=e;
    this.fclass=t;
}
...
this.tooltip.setContent(u);
    ...
    r("#jqstooltip").remove();
    this.sizetip=r("<div/>",  {
    id: "jqssizetip", style:i, "class":n;
}
);
    this.tooltip=r("<div/>",  {
    id: "jqstooltip", "class":n;
}
...
f=g.fclass||"jqsfield";
    ...
    r.extend(s[b],  {
    prefix: e.get("tooltipPrefix"), suffix:e.get("tooltipSuffix");
}
);
...
return""}, getCurrentRegionFields: function() {
}
...
if(i) {
    s=/^#([0-9a-f])([0-9a-f])([0-9a-f])$/i.exec(e)||/^#([0-9a-f] {
    2;
}
)([0-9a-f] {
    2;
...
, getRegion: function(e, t, r) {
    ...
    return {
    isNull: this.yvalues[e]===null, x:this.xvalues[e], y:this.yvalues[e], color:this.options.get("lineColor"), fillColor:this.options.get("fillColor"), offset:e;
}
}, renderHighlight:function() {
...
, getCurrentRegionFields:function() {
    ...
    r=t[i];
    n.push( {
    isNull: r===null, value:r, color:this.calcColor(i, r, e), offset:e;
}
);
}return n;
...
, getCurrentRegionFields: function() {
    var e=this.currentRegion;
    return {
    isNull: this.values[e]===n, value:this.values[e], color:this.calcColor(this.values[e], e), offset:e;
}
...
, getCurrentRegionFields: function() {
    var e=this.currentRegion;
    return {
    isNull: this.values[e]===n, value:this.values[e], offset:e;
}
}, renderRegion:function(e, n) {
...
, getCurrentRegionFields:function() {
    var e=this.currentRegion;
    return {
    fieldkey: e.substr(0, 1), value:this.values[e.substr(1)], region:e;
}
}, changeHighlight:function(e) {
    var t=this.currentRegion, n=this.valueShapes[t], r;
    delete this.shapes[n];
    switch(t.substr(0, 1)) {
    case"r": r=this.renderRange(t.substr(1), e);
    break;
    case"p": r=this.renderPerformance(e);
    break;
    case"t": r=this.renderTarget(e);
    break;
}
...
, getCurrentRegionFields:function() {
    var e=this.currentRegion;
    return {
    isNull: this.values[e]===n, value:this.values[e], percent:this.values[e]/this.total*100, color:this.options.get("sliceColors")[e%this.options.get("sliceColors").length], offset:e;
}
}, changeHighlight:function(e) {
...
r.data(s, "_jqs_vcanvas", this);
    r(this.canvas).css( {
    display: "inline-block", width:t, height:i, verticalAlign:"top"}
);
...
r.data(i, "_jqs_vcanvas", this);
    ...
    r(this.canvas).css( {
    display: "inline-block", position:"relative", overflow:"hidden", width:t, height:n, margin:"0px", padding:"0px", verticalAlign:"top"}
);
    this._insert(this.canvas, i);
    this._calculatePixelDims(t, n, this.canvas);
    this.canvas.width=this.pixelWidth;
    this.canvas.height=this.pixelHeight;
    s='<v: group coordorigin="0 0" coordsize="'+this.pixelWidth+" "+this.pixelHeight+'"'+' style="position:absolute;
    top: 0;
    left: 0;
...
u=o.splice(0, 1);
    ...
    c='<v: shape coordorigin="0 0" coordsize="'+this.pixelWidth+" "+this.pixelHeight+'" '+' id="jqsshape'+e+'" '+a+f+' style="position:absolute;
    left: 0px;
    top: 0px;
    height: '+this.pixelHeight+"px;
    width: "+this.pixelWidth+'px;
...
, _drawCircle: function(e, t, r, i, s, o, u) {
    ...
    l="<v: oval "+' id="jqsshape'+e+'" '+a+f+' style="position:absolute;
    top: '+r+"px;
     left: "+t+"px;
     width: "+i*2+"px;
     height: "+i*2+'px"></v:oval>';
    return l;
}
...
l=[r-s, i-s, r+s, i+s, c, h, p, d];
    ...
    g='<v: shape coordorigin="0 0" coordsize="'+this.pixelWidth+" "+this.pixelHeight+'" '+' id="jqsshape'+e+'" '+v+m+' style="position:absolute;
    left: 0px;
    top: 0px;
    height: '+this.pixelHeight+"px;
    width: "+this.pixelWidth+'px;
    padding: 0px;
    margin: 0px;
    " '+' path="m '+r+", "+i+" wa "+l.join(",  ")+' x e">'+" </v: shape>";
    return g;
}
, _drawRect: function(e, t, n, r, i, s, o) {
