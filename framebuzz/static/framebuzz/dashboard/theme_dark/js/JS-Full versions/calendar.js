...
var defaults = {
	...
	buttonText: {
		prev: "<span class='fc-text-arrow'><i class='icon-angle-left'></i></span>",
		next: "<span class='fc-text-arrow'><i class='icon-angle-right'></i></span>",
		prevYear: "<span class='fc-text-arrow'><i class='icon-double-angle-left'></i></span>",
		nextYear: "<span class='fc-text-arrow'><i class='icon-double-angle-right'></i></span>",
		today: 'Today',
		month: 'Month',
		week: 'Week',
		day: 'Day'
				...
				$.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							var button = $(
								"<span class='fc-button btn btn-sm btn-gr-gray fc-button-" + buttonName + " " + tm + "-state-default'>" +
									(icon ?
