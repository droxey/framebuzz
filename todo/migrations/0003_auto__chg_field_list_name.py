...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'List.name'
        db.alter_column(u'todo_list', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'List.name'
        db.alter_column(u'todo_list', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))
